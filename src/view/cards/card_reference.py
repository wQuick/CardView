...
from ..common.common_strings import REFERENCE
...
#
# ------------------------------------------------------------------------
class ReferenceCard(PrimaryCard):
    """
    The ReferenceCard class provides support for object References.
    """

    def __init__(self, grstate, groptions, primary_obj, reference_tuple=None):
        PrimaryCard.__init__(
            self,
            grstate,
            groptions,
            primary_obj,
