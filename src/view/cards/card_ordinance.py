...
#
# ------------------------------------------------------------------------
class LDSOrdinanceCard(SecondaryCard):
    """
    The LDSOrdinanceCard exposes the basic facts about an Ordinance.
    """

    def __init__(self, grstate, groptions, obj, ordinance):
        SecondaryCard.__init__(self, grstate, groptions, obj, ordinance)
    ...
    def __add_ordinance_title(self, ordinance):
        ...
        Add ordinance title.
        """
        title = "%s: %s" % (_("LDS"), ordinance.type2str())
        label = self.get_link(
            title,
            self.primary.obj,
