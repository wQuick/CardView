...
from ..common.common_utils import get_confidence, get_confidence_color_css
...
#
# ------------------------------------------------------------------------
class CitationCard(PrimaryCard):
    """
    The CitationCard exposes some of the basic facts about a Citation.
    """

    def __init__(self, grstate, groptions, citation, reference=None):
        PrimaryCard.__init__(self, grstate, groptions, citation)
