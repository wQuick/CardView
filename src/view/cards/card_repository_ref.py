...
#
# ------------------------------------------------------------------------
class RepositoryRefCard(RepositoryCard):
    """
    The RepositoryRefCard exposes some of the basic facts about a
    ...
    def add_ref_custom_actions(self, context_menu):
        ...
        context_menu.append(
            menu_item(
                "gtk-edit", EDIT_REFERENCE, action.edit_repository_reference
            )
        )
