...
"""
Widgets supporting various sections of the card.
"""
...
#
# ------------------------------------------------------------------------
from .card_utils import get_tag_icon
...
class CardGrid(Gtk.Grid):
    """
    A simple class to manage a fact grid for a Gramps card.
    """
...
#
# ------------------------------------------------------------------------
class CardIcons(Gtk.HBox, GrampsConfig):
    """
...
class GrampsImage(Gtk.EventBox):
    """
    A simple class for managing display of an image for a Card object.
    """
