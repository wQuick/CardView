...
# ------------------------------------------------------------------------
#
# ResearchNotesCardGroup Class
#
# ------------------------------------------------------------------------
class ResearchNotesCardGroup(CardGroupList):
    """
    The ResearchNotesCardGroup class provides a container for managing all
    ...
    def __init__(self, grstate, groptions, obj):
        ...
        for (obj_lang, handle) in notes:
            ...
            if note.get_type() == NoteType.RESEARCH:
