...
from .config_const import (
    ...
    OPTION_VALUE_BANNS,
    OPTION_VALUE_LICENSE,
    OPTION_VALUE_CONTRACT,
    OPTION_VALUE_SETTLEMENT,
    OPTION_VALUE_MARRIAGE,
    OPTION_VALUE_FILING,
    OPTION_VALUE_DIVORCE,
    OPTION_VALUE_ANNULMENT,
    OPTION_VALUE_DURATION,
    OPTION_VALUE_RELATIONSHIP,
    OPTION_VALUE_OCCUPATIONS,
    OPTION_VALUE_PATERNAL,
    OPTION_VALUE_MATERNAL,
    OPTION_VALUE_BRIDE,
    OPTION_VALUE_GROOM,
    OPTION_VALUE_CHILD,
)
...
VIEWDEFAULTS = (
    ...
    ## Display Options
    ######################################################################
    ("display.max-page-windows", 4),
    ("display.max-group-windows", 4),
    ("display.pin-header", True),
    ...
    ######################################################################
    ("indicator.gramps-ids", True),
    ("indicator.privacy", 1),
    ("indicator.bookmarks", True),
    ...
    ("active.person.lfield-skip-birth-alternates", False),
    ("active.person.lfield-skip-death-alternates", False),
    ("active.person.lfield-1", OPTION_VALUE_BIRTH),
    ("active.person.lfield-2", OPTION_VALUE_BAPTISM),
    ("active.person.lfield-3", OPTION_VALUE_CHRISTENING),
    ("active.person.lfield-4", OPTION_VALUE_WILL),
    ("active.person.lfield-5", OPTION_VALUE_DEATH),
    ("active.person.lfield-6", OPTION_VALUE_BURIAL),
    ("active.person.lfield-7", OPTION_VALUE_CREMATION),
    ("active.person.lfield-8", OPTION_VALUE_PROBATE),
    ("active.person.lfield-9", OPTION_VALUE_DURATION),
    ("active.person.lfield-10", "None"),
    ("active.person.mfield-skip-birth-alternates", False),
    ("active.person.mfield-skip-death-alternates", False),
    ("active.person.mfield-1", OPTION_VALUE_OCCUPATIONS),
    ("active.person.mfield-2", OPTION_VALUE_PATERNAL),
    ("active.person.mfield-3", OPTION_VALUE_MATERNAL),
    ("active.person.mfield-4", OPTION_VALUE_CHILD),
    ...
    ("active.parent.lfield-1", OPTION_VALUE_BIRTH),
    ("active.parent.lfield-2", OPTION_VALUE_BAPTISM),
    ("active.parent.lfield-3", OPTION_VALUE_CHRISTENING),
    ("active.parent.lfield-4", OPTION_VALUE_WILL),
    ("active.parent.lfield-5", OPTION_VALUE_DEATH),
    ("active.parent.lfield-6", OPTION_VALUE_BURIAL),
    ("active.parent.lfield-7", OPTION_VALUE_CREMATION),
    ("active.parent.lfield-8", OPTION_VALUE_PROBATE),
    ("active.parent.lfield-9", OPTION_VALUE_DURATION),
    ...
    ("active.spouse.lfield-1", OPTION_VALUE_BIRTH),
    ("active.spouse.lfield-2", OPTION_VALUE_BAPTISM),
    ("active.spouse.lfield-3", OPTION_VALUE_CHRISTENING),
    ("active.spouse.lfield-4", OPTION_VALUE_WILL),
    ("active.spouse.lfield-5", OPTION_VALUE_DEATH),
    ("active.spouse.lfield-6", OPTION_VALUE_BURIAL),
    ("active.spouse.lfield-7", OPTION_VALUE_CREMATION),
    ("active.spouse.lfield-8", OPTION_VALUE_PROBATE),
    ("active.spouse.lfield-9", OPTION_VALUE_DURATION),
    ...
    ("active.association.lfield-1", OPTION_VALUE_BIRTH),
    ("active.association.lfield-2", OPTION_VALUE_BAPTISM),
    ("active.association.lfield-3", OPTION_VALUE_CHRISTENING),
    ("active.association.lfield-4", OPTION_VALUE_WILL),
    ("active.association.lfield-5", OPTION_VALUE_DEATH),
    ("active.association.lfield-6", OPTION_VALUE_BURIAL),
    ("active.association.lfield-7", OPTION_VALUE_CREMATION),
    ("active.association.lfield-8", OPTION_VALUE_PROBATE),
    ("active.association.lfield-9", OPTION_VALUE_DURATION),
    ...
    ("active.family.lfield-skip-marriage-alternates", False),
    ("active.family.lfield-skip-divorce-alternates", False),
    ("active.family.lfield-1", OPTION_VALUE_BANNS),
    ("active.family.lfield-2", OPTION_VALUE_LICENSE),
    ("active.family.lfield-3", OPTION_VALUE_CONTRACT),
    ("active.family.lfield-4", OPTION_VALUE_SETTLEMENT),
    ("active.family.lfield-5", OPTION_VALUE_MARRIAGE),
    ("active.family.lfield-6", OPTION_VALUE_FILING),
    ("active.family.lfield-7", OPTION_VALUE_DIVORCE),
    ("active.family.lfield-8", OPTION_VALUE_ANNULMENT),
    ("active.family.lfield-9", OPTION_VALUE_DURATION),
    ("active.family.lfield-10", "None"),
    ("active.family.mfield-skip-marriage-alternates", False),
    ("active.family.mfield-skip-divorce-alternates", False),
    ("active.family.mfield-1", OPTION_VALUE_BRIDE),
    ("active.family.mfield-2", OPTION_VALUE_GROOM),
    ("active.family.mfield-3", OPTION_VALUE_RELATIONSHIP),
    ...
    ("active.event.show-description", True),
    ("active.event.show-participants", True),
    ("active.event.show-role-always", False),
    ("active.event.show-source-count", True),
    ("active.event.show-citation-count", True),
    ("active.event.show-best-confidence", True),
    ######################################################################
    ## Place Options
    ######################################################################
    ...
    ("group.person.image-mode", 1),
    ("group.person.lfield-skip-birth-alternates", False),
    ("group.person.lfield-skip-death-alternates", False),
    ("group.person.lfield-1", OPTION_VALUE_BIRTH),
    ("group.person.lfield-2", OPTION_VALUE_BAPTISM),
    ("group.person.lfield-3", OPTION_VALUE_CHRISTENING),
    ("group.person.lfield-4", OPTION_VALUE_WILL),
    ("group.person.lfield-5", OPTION_VALUE_DEATH),
    ("group.person.lfield-6", OPTION_VALUE_BURIAL),
    ("group.person.lfield-7", OPTION_VALUE_CREMATION),
    ("group.person.lfield-8", OPTION_VALUE_PROBATE),
    ("group.person.lfield-9", OPTION_VALUE_DURATION),
    ("group.person.lfield-10", "None"),
    ("group.person.mfield-skip-birth-alternates", False),
    ("group.person.mfield-skip-death-alternates", False),
    ...
    ## Paternal Options
    ######################################################################
    ("group.paternal.display-mode", 1),
    ######################################################################
    ## Maternal Options
    ######################################################################
    ("group.maternal.display-mode", 1),
    ######################################################################
    ## Parent Options
    ######################################################################
    ...
    ("group.parent.image-mode", 1),
    ("group.parent.lfield-skip-birth-alternates", True),
    ("group.parent.lfield-skip-death-alternates", True),
    ("group.parent.lfield-1", OPTION_VALUE_BIRTH),
    ("group.parent.lfield-2", OPTION_VALUE_BAPTISM),
    ("group.parent.lfield-3", OPTION_VALUE_CHRISTENING),
    ("group.parent.lfield-4", OPTION_VALUE_WILL),
    ("group.parent.lfield-5", OPTION_VALUE_DEATH),
    ("group.parent.lfield-6", OPTION_VALUE_BURIAL),
    ("group.parent.lfield-7", OPTION_VALUE_CREMATION),
    ("group.parent.lfield-8", OPTION_VALUE_PROBATE),
    ("group.parent.lfield-9", OPTION_VALUE_DURATION),
    ...
    ("group.sibling.image-mode", 1),
    ("group.sibling.number-children", True),
    ("group.sibling.reference-mode", 1),
    ("group.sibling.lfield-skip-birth-alternates", True),
    ("group.sibling.lfield-skip-death-alternates", True),
    ("group.sibling.lfield-1", OPTION_VALUE_BIRTH),
    ("group.sibling.lfield-2", OPTION_VALUE_BAPTISM),
    ("group.sibling.lfield-3", OPTION_VALUE_CHRISTENING),
    ("group.sibling.lfield-4", OPTION_VALUE_WILL),
    ("group.sibling.lfield-5", OPTION_VALUE_DEATH),
    ("group.sibling.lfield-6", OPTION_VALUE_BURIAL),
    ("group.sibling.lfield-7", OPTION_VALUE_CREMATION),
    ("group.sibling.lfield-8", OPTION_VALUE_PROBATE),
    ("group.sibling.lfield-9", OPTION_VALUE_DURATION),
    ...
    ("group.spouse.image-mode", 1),
    ("group.spouse.lfield-skip-birth-alternates", True),
    ("group.spouse.lfield-skip-death-alternates", True),
    ("group.spouse.lfield-1", OPTION_VALUE_BIRTH),
    ("group.spouse.lfield-2", OPTION_VALUE_BAPTISM),
    ("group.spouse.lfield-3", OPTION_VALUE_CHRISTENING),
    ("group.spouse.lfield-4", OPTION_VALUE_WILL),
    ("group.spouse.lfield-5", OPTION_VALUE_DEATH),
    ("group.spouse.lfield-6", OPTION_VALUE_BURIAL),
    ("group.spouse.lfield-7", OPTION_VALUE_CREMATION),
    ("group.spouse.lfield-8", OPTION_VALUE_PROBATE),
    ("group.spouse.lfield-9", OPTION_VALUE_DURATION),
    ...
    ("group.child.image-mode", 1),
    ("group.child.number-children", True),
    ("group.child.reference-mode", 1),
    ("group.child.lfield-skip-birth-alternates", True),
    ("group.child.lfield-skip-death-alternates", True),
    ("group.child.lfield-1", OPTION_VALUE_BIRTH),
    ("group.child.lfield-2", OPTION_VALUE_BAPTISM),
    ("group.child.lfield-3", OPTION_VALUE_CHRISTENING),
    ("group.child.lfield-4", OPTION_VALUE_WILL),
    ("group.child.lfield-5", OPTION_VALUE_DEATH),
    ("group.child.lfield-6", OPTION_VALUE_BURIAL),
    ("group.child.lfield-7", OPTION_VALUE_CREMATION),
    ("group.child.lfield-8", OPTION_VALUE_PROBATE),
    ("group.child.lfield-9", OPTION_VALUE_DURATION),
    ...
    ("group.association.image-mode", 1),
    ("group.association.reference-mode", 1),
    ("group.association.lfield-skip-birth-alternates", True),
    ("group.association.lfield-skip-death-alternates", True),
    ("group.association.lfield-1", OPTION_VALUE_BIRTH),
    ("group.association.lfield-2", OPTION_VALUE_BAPTISM),
    ("group.association.lfield-3", OPTION_VALUE_CHRISTENING),
    ("group.association.lfield-4", OPTION_VALUE_WILL),
    ("group.association.lfield-5", OPTION_VALUE_DEATH),
    ("group.association.lfield-6", OPTION_VALUE_BURIAL),
    ("group.association.lfield-7", OPTION_VALUE_CREMATION),
    ("group.association.lfield-8", OPTION_VALUE_PROBATE),
    ("group.association.lfield-9", OPTION_VALUE_DURATION),
    ...
    ("group.family.image-mode", 1),
    ("group.family.compact-mode", True),
    ("group.family.lfield-skip-marriage-alternates", False),
    ("group.family.lfield-skip-divorce-alternates", False),
    ("group.family.lfield-1", OPTION_VALUE_RELATIONSHIP),
    ("group.family.lfield-2", OPTION_VALUE_BANNS),
    ("group.family.lfield-3", OPTION_VALUE_LICENSE),
    ("group.family.lfield-4", OPTION_VALUE_CONTRACT),
    ("group.family.lfield-5", OPTION_VALUE_SETTLEMENT),
    ("group.family.lfield-6", OPTION_VALUE_MARRIAGE),
    ("group.family.lfield-7", OPTION_VALUE_FILING),
    ("group.family.lfield-8", OPTION_VALUE_DIVORCE),
    ("group.family.lfield-9", OPTION_VALUE_ANNULMENT),
    ("group.family.lfield-10", OPTION_VALUE_DURATION),
    ...
    ("group.event.show-description", True),
    ("group.event.show-participants", True),
    ("group.event.show-role-always", False),
    ("group.event.show-source-count", True),
    ("group.event.show-citation-count", True),
    ("group.event.show-best-confidence", True),
    ######################################################################
    ## Ordinance Options
    ######################################################################
    ...
    ("group.citation.show-reference-type", True),
    ("group.citation.show-reference-description", True),
    ("group.citation.show-confidence", True),
    ...
    ("timeline.person.reference-mode", 1),
    ...
    ("timeline.person.show-description", True),
    ("timeline.person.show-participants", True),
    ("timeline.person.show-role-always", False),
    ("timeline.person.show-source-count", True),
    ("timeline.person.show-citation-count", True),
    ("timeline.person.show-best-confidence", True),
    ...
    ("timeline.family.reference-mode", 1),
    ...
    ("timeline.family.show-description", True),
    ("timeline.family.show-participants", True),
    ("timeline.family.show-role-always", False),
    ("timeline.family.show-source-count", True),
    ("timeline.family.show-citation-count", True),
    ("timeline.family.show-best-confidence", True),
    ...
    ("layout.statistics.stats-place.visible", True),
    ("layout.statistics.stats-place.append", True),
    ("layout.statistics.stats-media.visible", True),
    ("layout.statistics.stats-media.append", True),
    ("layout.statistics.stats-note.visible", True),
    ("layout.statistics.stats-note.append", True),
    ("layout.statistics.stats-tag.visible", True),
    ("layout.statistics.stats-tag.append", True),
    ("layout.statistics.stats-bookmark.visible", True),
